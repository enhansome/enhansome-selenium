...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,465 | 🐛 105 | 📅 2026-08-21 list thing.
...
* [selenium-webdriver](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29 - The official WebDriver JavaScript bindings from the Selenium project.
...
* [Anemone](https://github.com/chriskite/anemone) ⭐ 1,600 | 🐛 50 | 🌐 Ruby | 📅 2020-03-20 - Anemone web-spider framework.
...
* [Helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,323 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - Helium makes Selenium easier and faster to use
...
* [WebDriverManager](https://github.com/bonigarcia/webdrivermanager) ⭐ 2,686 | 🐛 0 | 🌐 Java | 📅 2026-08-29 - Automatic management of Selenium WebDriver binaries.
* [Selenide](https://github.com/codeborne/selenide) ⭐ 1,909 | 🐛 31 | 🌐 Java | 📅 2026-08-29 - A framework for writing easy-to-read and easy-to-maintain automated tests using a Fluent API. Selenide has a magic trick that resolves most problems with Ajax and timeouts.
* [seleniumQuery](https://github.com/seleniumQuery/seleniumQuery) ⭐ 73 | 🐛 2 | 🌐 Java | 📅 2025-07-12 - jQuery-like cross-driver interface in Java for WebDriver. Designed as a thin layer, it can be used alone or on top of your favorite framework just to make some cases (e.g. asserting/waiting) simpler when needed.
...
* [Website-Diff](https://github.com/GeiserX/Website-Diff) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Intelligent web page comparison tool with Wayback Machine support and visual regression testing via Selenium.
...
* [SeleniumHQ/docker-selenium](https://github.com/SeleniumHQ/docker-selenium) ⭐ 8,648 | 🐛 89 | 🌐 Go | 📅 2026-08-30 - Docker images for Selenium Standalone Server, Hub, and Node configurations with Chrome and Firefox.
...
* [kubernetes/examples](https://github.com/kubernetes/examples/tree/master/staging/selenium) ⭐ 6,688 | 🐛 3 | 🌐 Shell | 📅 2026-03-03 - Example deployment of Selenium Hub and Nodes on a Kubernetes cluster
...
* [Firefox](https://github.com/SeleniumHQ/selenium/wiki/FirefoxDriver) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29 - Firefox driver (for FF < v48) is included in the selenium-server-standalone.jar available in the downloads.
* [Internet Explorer](https://github.com/SeleniumHQ/selenium/wiki/InternetExplorerDriver) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29 - The InternetExplorerDriver is a standalone server which implements WebDriver's wire protocol.
* [Safari](https://github.com/SeleniumHQ/selenium/wiki/SafariDriver) ⭐ 34,426 | 🐛 191 | 🌐 Java | 📅 2026-08-29 - The SafariDriver is implemented as a Safari browser extension. The driver inverts the traditional client/server relationship and communicates with the WebDriver client using WebSockets (only supported for Safari <= v9, all new Safari version comming with macOS Sierra come with an integrated SafariDriver that is closed source by Apple).
...
* [OpenSTF](https://github.com/DeviceFarmer/stf) ⭐ 4,546 | 🐛 179 | 🌐 JavaScript | 📅 2026-08-29 - A framework for running your own device farm, geared toward Android, but also iOS.

### Web Scraping / Mining

* [Node-Crawler](https://github.com/sylvinus/node-crawler) ⭐ 6,798 | 🐛 29 | 🌐 TypeScript | 📅 2026-06-18 - **Node.js** Web Crawler/Spider for NodeJS + server-side jQuery.
