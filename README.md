...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,816 | 🐛 102 | 📅 2026-08-18 list thing.
...
* [selenium-webdriver](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,380 | 🐛 186 | 🌐 Java | 📅 2026-08-19 - The official WebDriver JavaScript bindings from the Selenium project.
...
* [Spidr](https://github.com/postmodern/spidr) ⭐ 835 | 🐛 16 | 🌐 Ruby | 📅 2026-01-12 - web spidering library that can spider a site, multiple domains, certain links or infinitely.
...
* [Facebook WebDriver](https://github.com/facebook/php-webdriver) ⭐ 5,200 | 🐛 30 | 🌐 PHP | 📅 2026-08-14 - A PHP client for webdriver.
...
* [Selene](https://github.com/yashaka/selene) ⭐ 733 | 🐛 123 | 🌐 Python | 📅 2026-08-09 - Selenide-inspired concise and readable automated test framework, supports Ajax well like Selenide.
...
* [WebDriverManager](https://github.com/bonigarcia/webdrivermanager) ⭐ 2,686 | 🐛 0 | 🌐 Java | 📅 2026-08-14 - Automatic management of Selenium WebDriver binaries.
* [Selenide](https://github.com/codeborne/selenide) ⭐ 1,908 | 🐛 34 | 🌐 Java | 📅 2026-08-19 - A framework for writing easy-to-read and easy-to-maintain automated tests using a Fluent API. Selenide has a magic trick that resolves most problems with Ajax and timeouts.
...
* [SeleniumHQ/docker-selenium](https://github.com/SeleniumHQ/docker-selenium) ⭐ 8,647 | 🐛 87 | 🌐 Go | 📅 2026-08-19 - Docker images for Selenium Standalone Server, Hub, and Node configurations with Chrome and Firefox.
...
* [kubernetes/examples](https://github.com/kubernetes/examples/tree/master/staging/selenium) ⭐ 6,682 | 🐛 3 | 🌐 Shell | 📅 2026-03-03 - Example deployment of Selenium Hub and Nodes on a Kubernetes cluster
* [Moon](https://github.com/aerokube/moon) ⭐ 278 | 🐛 84 | 🌐 HTML | 📅 2026-04-03 - A commercial closed-source enterprise Selenium implementation using Kubernetes to launch browsers
...
* [Firefox](https://github.com/SeleniumHQ/selenium/wiki/FirefoxDriver) ⭐ 34,380 | 🐛 186 | 🌐 Java | 📅 2026-08-19 - Firefox driver (for FF < v48) is included in the selenium-server-standalone.jar available in the downloads.
* [Internet Explorer](https://github.com/SeleniumHQ/selenium/wiki/InternetExplorerDriver) ⭐ 34,380 | 🐛 186 | 🌐 Java | 📅 2026-08-19 - The InternetExplorerDriver is a standalone server which implements WebDriver's wire protocol.
* [Safari](https://github.com/SeleniumHQ/selenium/wiki/SafariDriver) ⭐ 34,380 | 🐛 186 | 🌐 Java | 📅 2026-08-19 - The SafariDriver is implemented as a Safari browser extension. The driver inverts the traditional client/server relationship and communicates with the WebDriver client using WebSockets (only supported for Safari <= v9, all new Safari version comming with macOS Sierra come with an integrated SafariDriver that is closed source by Apple).
* [Geckodriver](https://github.com/mozilla/geckodriver) ⭐ 7,477 | 🐛 192 | 📅 2026-07-23 - Firefox driver (for FF > v48), supported with Selenium >= v3
...
* [WinAppDriver](https://github.com/Microsoft/WinAppDriver) ⭐ 4,045 | 🐛 1,155 | 🌐 C# | 📅 2025-04-14 - Microsoft's WebDriver implementation for Windows application automation.
...
* [OpenSTF](https://github.com/DeviceFarmer/stf) ⭐ 4,538 | 🐛 173 | 🌐 JavaScript | 📅 2026-08-19 - A framework for running your own device farm, geared toward Android, but also iOS.
