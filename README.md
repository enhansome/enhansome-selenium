...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,255 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [selenium-webdriver](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,503 | 🐛 192 | 🌐 Java | 📅 2026-09-20 - The official WebDriver JavaScript bindings from the Selenium project.
...
* [Facebook WebDriver](https://github.com/facebook/php-webdriver) ⭐ 5,198 | 🐛 32 | 🌐 PHP | 📅 2026-09-04 - A PHP client for webdriver.
...
* [Helium](https://github.com/mherrmann/selenium-python-helium) ⭐ 8,318 | 🐛 55 | 🌐 Python | 📅 2026-08-10 - Helium makes Selenium easier and faster to use
* [Selene](https://github.com/yashaka/selene) ⭐ 732 | 🐛 124 | 🌐 Python | 📅 2026-09-09 - Selenide-inspired concise and readable automated test framework, supports Ajax well like Selenide.
...
* [WebDriverManager](https://github.com/bonigarcia/webdrivermanager) ⭐ 2,692 | 🐛 1 | 🌐 Java | 📅 2026-09-18 - Automatic management of Selenium WebDriver binaries.
* [Selenide](https://github.com/codeborne/selenide) ⭐ 1,911 | 🐛 37 | 🌐 Java | 📅 2026-09-19 - A framework for writing easy-to-read and easy-to-maintain automated tests using a Fluent API. Selenide has a magic trick that resolves most problems with Ajax and timeouts.
...
* [dart.webdriver](https://github.com/google/webdriver.dart) ⭐ 142 | 🐛 26 | 🌐 Dart | 📅 2026-09-11 - Provides WebDriver bindings for Dart. These use the WebDriver JSON interface, and as such, require the use of the WebDriver remote server.
...
* [Website-Diff](https://github.com/GeiserX/Website-Diff) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Intelligent web page comparison tool with Wayback Machine support and visual regression testing via Selenium.
...
* [SeleniumHQ/docker-selenium](https://github.com/SeleniumHQ/docker-selenium) ⭐ 8,653 | 🐛 91 | 🌐 Go | 📅 2026-09-18 - Docker images for Selenium Standalone Server, Hub, and Node configurations with Chrome and Firefox.
...
* [kubernetes/examples](https://github.com/kubernetes/examples/tree/master/staging/selenium) ⭐ 6,760 | 🐛 3 | 🌐 Shell | 📅 2026-03-03 - Example deployment of Selenium Hub and Nodes on a Kubernetes cluster
* [Moon](https://github.com/aerokube/moon) ⭐ 279 | 🐛 84 | 🌐 HTML | 📅 2026-09-12 - A commercial closed-source enterprise Selenium implementation using Kubernetes to launch browsers
...
* [Firefox](https://github.com/SeleniumHQ/selenium/wiki/FirefoxDriver) ⭐ 34,503 | 🐛 192 | 🌐 Java | 📅 2026-09-20 - Firefox driver (for FF < v48) is included in the selenium-server-standalone.jar available in the downloads.
* [Internet Explorer](https://github.com/SeleniumHQ/selenium/wiki/InternetExplorerDriver) ⭐ 34,503 | 🐛 192 | 🌐 Java | 📅 2026-09-20 - The InternetExplorerDriver is a standalone server which implements WebDriver's wire protocol.
* [Safari](https://github.com/SeleniumHQ/selenium/wiki/SafariDriver) ⭐ 34,503 | 🐛 192 | 🌐 Java | 📅 2026-09-20 - The SafariDriver is implemented as a Safari browser extension. The driver inverts the traditional client/server relationship and communicates with the WebDriver client using WebSockets (only supported for Safari <= v9, all new Safari version comming with macOS Sierra come with an integrated SafariDriver that is closed source by Apple).
* [Geckodriver](https://github.com/mozilla/geckodriver) ⭐ 7,478 | 🐛 191 | 📅 2026-08-25 - Firefox driver (for FF > v48), supported with Selenium >= v3
* [Opera](https://github.com/operasoftware/operachromiumdriver/blob/master/README.md) ⭐ 267 | 🐛 78 | 📅 2026-09-02 - OperaDriver is a vendor-supported WebDriver implementation developed by Opera Software and volunteers that implements WebDriver API for Opera.
...
* [WinAppDriver](https://github.com/Microsoft/WinAppDriver) ⭐ 4,053 | 🐛 1,155 | 🌐 C# | 📅 2025-04-14 - Microsoft's WebDriver implementation for Windows application automation.
...
* [OpenSTF](https://github.com/DeviceFarmer/stf) ⭐ 4,567 | 🐛 163 | 🌐 JavaScript | 📅 2026-09-19 - A framework for running your own device farm, geared toward Android, but also iOS.

### Web Scraping / Mining

* [Node-Crawler](https://github.com/sylvinus/node-crawler) ⭐ 6,793 | 🐛 29 | 🌐 TypeScript | 📅 2026-06-18 - **Node.js** Web Crawler/Spider for NodeJS + server-side jQuery.
