...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,034 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [selenium-webdriver](https://github.com/SeleniumHQ/selenium/wiki/WebDriverJs) ⭐ 34,512 | 🐛 188 | 🌐 Java | 📅 2026-09-22 - The official WebDriver JavaScript bindings from the Selenium project.
...
* [Facebook WebDriver](https://github.com/facebook/php-webdriver) ⭐ 5,196 | 🐛 32 | 🌐 PHP | 📅 2026-09-22 - A PHP client for webdriver.
...
* [WebDriverManager](https://github.com/bonigarcia/webdrivermanager) ⭐ 2,692 | 🐛 1 | 🌐 Java | 📅 2026-09-22 - Automatic management of Selenium WebDriver binaries.
* [Selenide](https://github.com/codeborne/selenide) ⭐ 1,911 | 🐛 37 | 🌐 Java | 📅 2026-09-22 - A framework for writing easy-to-read and easy-to-maintain automated tests using a Fluent API. Selenide has a magic trick that resolves most problems with Ajax and timeouts.
...
* [kubernetes/examples](https://github.com/kubernetes/examples/tree/master/staging/selenium) ⭐ 6,761 | 🐛 4 | 🌐 Shell | 📅 2026-03-03 - Example deployment of Selenium Hub and Nodes on a Kubernetes cluster
...
* [Firefox](https://github.com/SeleniumHQ/selenium/wiki/FirefoxDriver) ⭐ 34,512 | 🐛 188 | 🌐 Java | 📅 2026-09-22 - Firefox driver (for FF < v48) is included in the selenium-server-standalone.jar available in the downloads.
* [Internet Explorer](https://github.com/SeleniumHQ/selenium/wiki/InternetExplorerDriver) ⭐ 34,512 | 🐛 188 | 🌐 Java | 📅 2026-09-22 - The InternetExplorerDriver is a standalone server which implements WebDriver's wire protocol.
* [Safari](https://github.com/SeleniumHQ/selenium/wiki/SafariDriver) ⭐ 34,512 | 🐛 188 | 🌐 Java | 📅 2026-09-22 - The SafariDriver is implemented as a Safari browser extension. The driver inverts the traditional client/server relationship and communicates with the WebDriver client using WebSockets (only supported for Safari <= v9, all new Safari version comming with macOS Sierra come with an integrated SafariDriver that is closed source by Apple).
* [Geckodriver](https://github.com/mozilla/geckodriver) ⭐ 7,479 | 🐛 191 | 📅 2026-08-25 - Firefox driver (for FF > v48), supported with Selenium >= v3
* [Opera](https://github.com/operasoftware/operachromiumdriver/blob/master/README.md) ⭐ 267 | 🐛 78 | 📅 2026-09-22 - OperaDriver is a vendor-supported WebDriver implementation developed by Opera Software and volunteers that implements WebDriver API for Opera.
...
* [WinAppDriver](https://github.com/Microsoft/WinAppDriver) ⭐ 4,053 | 🐛 1,157 | 🌐 C# | 📅 2025-04-14 - Microsoft's WebDriver implementation for Windows application automation.
...
* [OpenSTF](https://github.com/DeviceFarmer/stf) ⭐ 4,567 | 🐛 161 | 🌐 JavaScript | 📅 2026-09-22 - A framework for running your own device farm, geared toward Android, but also iOS.
